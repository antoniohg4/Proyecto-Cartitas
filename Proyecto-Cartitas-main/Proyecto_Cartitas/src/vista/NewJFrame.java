...
public class NewJFrame extends javax.swing.JFrame implements ActionListener{
    ...
    private int[] BTN_LONG={5,4};// La longitud del array de botones.
    /**
    ...
    public void crearEspacioDeCartas(){
        ...
        for (int i = 0; i < BTN_LONG[0]; i++) {
            for (int j = 0; j < BTN_LONG[1]; j++) {
                ...
                cartasItems[i][j].setSize(1,1);
                cartasItems[i][j].setMinimumSize(new java.awt.Dimension(1,1));
                cartasItems[i][j].setPreferredSize(new java.awt.Dimension(1,1));
            }
        }
    ...
    public void cargarFotosCartas() {
        ...
        for (Carta carta : gestion_BD.obtenerTodasLasCartas()) {
            imagenesCartas.add(new ImageIcon(getClass().getResource(carta.getUrl())));
        }

        System.out.println("cartas: "+imagenesCartas.size());
        int counter=0;
        
        for (int i = 0; i < BTN_LONG[0]; i++) {
            for (int j = 0; j < BTN_LONG[1]; j++) {

                ImageIcon fotoCarta = imagenesCartas.get(counter);
                counter++;
